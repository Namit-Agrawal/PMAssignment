...
ggplot(kmeansDF, aes(x=reorder(category,Cluster_4), y=Cluster_4), ylab = "Category",xlab = "Cluster 4") +
  geom_bar(stat='identity') + coord_flip()
ggplot(kmeansDF, aes(x=reorder(category,Cluster_5), y=Cluster_5), ylab = "Category",xlab = "Cluster 5") +
  geom_bar(stat='identity') + coord_flip()
```
...
Using the ReutersC50 dataset, we hope to predict the author that wrote a particular article based on the article's textual content.  
