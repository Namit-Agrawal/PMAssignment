...
We then perform PCA on our training dataset.  To ensure the principal components between both the training and testing dataset are equivalent, we project the observations of the test set into the PC space as defined by our training dataset.  We choose the first 500 PCs to improve computational speed.
```{r echo = FALSE,fig.align = "center",fig.width = 6,fig.height = 4}
...
accuracy
```
Using a the algorithm, we were able to achieve a roughly 53% accuracy on our dataset.\
